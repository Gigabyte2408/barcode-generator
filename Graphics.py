# Muhammad Ghanim Sial SPIRE ID: 31979219
...
def WriteBMP (FileName, Canvas):
    ...
    FileHeaderSize   = 14  # Bytes
    ImageHeaderSize  = 40  # Bytes
    BytesPerPixel    = 3   # Bytes
...
def addLine (Canvas,X1,Y1,X2,Y2,Color=black):
    ...
    Ay = Y2 - Y1
    for I in range(D+1):
        T = I / float(D)  #Parameter 0.0 ... 1.0
        X = Ax * T + X1   #Parametric Line for X
        Y = Ay * T + Y1   #Parametric Line for Y
